...
我的專業背景是 tech marketing 與產品管理，在公司裡扮演的是把各個產品和專案整合起來的角色。
Product Mission Control 是我以 Head of Products 的視角做的工具：要為公司的整個產品組合負責，就得
同時掌握每個產品和專案的方向、成果、交付承諾、決策、風險，還有支撐每一個判斷的證據。它先在我的
私人 repo 裡開發了一個多月，各項機制在過程中反覆調整、驗證，最後整理成這個公開的 repo，讓別人看得到它怎麼運作，也看得到
它是怎麼做出來的。
...
2026 年 8 月 17 日寫下第一行應用程式碼之前就凍結了。
