...
I am a Head of Products, not a career programmer. I built this by directing AI coding agents under
rules I set and enforced: Claude Code writes and tests one slice at a time, Codex reviews every slice
